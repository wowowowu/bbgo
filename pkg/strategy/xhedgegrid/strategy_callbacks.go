...
func (s *Strategy) OnGridProfit(cb func(stats *grid2.GridProfitStats, profit *grid2.GridProfit)) {
	s.gridProfitCallbacks = append(s.gridProfitCallbacks, cb)
}

func (s *Strategy) EmitGridProfit(stats *grid2.GridProfitStats, profit *grid2.GridProfit) {
